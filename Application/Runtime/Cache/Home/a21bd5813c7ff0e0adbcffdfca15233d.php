...
<body>
    ...
    <div class="tools">
        ...
        <li class="click" ><a href="<?php echo u('yjkh_add');?>?type=1"><span><img src="/wenjuan/Public/images/t01.png" /></span>绩效考核添加</a></li>
        <li class="click" ><a href="<?php echo u('yjkh_add');?>?type=2"><span><img src="/wenjuan/Public/images/t01.png" /></span>行为考核添加</a></li>
