...
<!-- <script language="JavaScript" src="/zhongyin/Public/js/jquery.min.js"></script> -->
<script src="/zhongyin/Public/js/cloud.js" type="text/javascript"></script>
...
<body style="background-color:#1c77ac; background-image:url(/zhongyin/Public/images/light.png); background-repeat:no-repeat; background-position:center top; overflow:hidden;">
