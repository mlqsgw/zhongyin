...
<body style="background:#f0f9fd;">
    ...
    <!-- <dd><div class="title"><span><img src="/zhongyin/Public/images/leftico03.png" /></span>问卷调查管理</div>
    <ul class="menuson">
    ...
    <dd><div class="title"><span><img src="/zhongyin/Public/images/leftico03.png" /></span>用户管理</div>
    <ul class="menuson">
        <li class="active"><cite></cite><a href="index.html" target="rightFrame">首页模版</a><i></i></li>
    ...
    <dd><div class="title"><span><img src="/zhongyin/Public/images/leftico04.png" /></span>管理员考核管理</div>
    <ul class="menuson">
    ...
    <dd><div class="title"><span><img src="/zhongyin/Public/images/leftico04.png" /></span>我的考核管理</div>
    <ul class="menuson">
