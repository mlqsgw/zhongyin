...
<body>
    ...
    <table class="tablelist">
        ...
        <td><a href="#" class="duty_edit" duty_edit_id = <?php echo ($vo["id"]); ?>>编辑</a>|<a href="#" class="duty_del" duty_del_id = <?php echo ($vo["id"]); ?>>删除</a></td>
    ...
    <script type="text/javascript">
       ...
       $(".duty_edit").click(function(){
            var edit_id = $(this).attr("duty_edit_id");
            var url3 = "<?php echo u('duty_edit');?>?id=" + edit_id;
            layer.open({
                type : 2,
                title : "绩绩考核编辑",
                area : ['1210px', '90%'],
       ...
       $(".duty_del").click(function(){
            var del_id = $(this).attr("duty_del_id");
            $.ajax({
                type : "POST",
                url : "<?php echo u('duty_del');?>",
                data : {id : del_id},
                dataType : 'json',
                success : function(data){
                    if(data['status']){
                        layer.open({
                            ...
                            btn : ['确定'],
                            yes : function(){
                                location.href = "<?php echo u('duty_list');?>";
                            }
                        });
                    } else {
                        layer.open({
