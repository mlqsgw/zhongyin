...
<html lang="zh-CN">
	<head>
		...
		<!-- 公告样式 -->
		<link rel="stylesheet" href="/zhongyin/Public/home/css/addCreditCard.css" id="css">
	  ...
	  <script src="/zhongyin/Public/home/js/common/flexible.js"></script>
		...
		<!-- 公共js -->
		<script src="/zhongyin/Public/home/js/addCreditCard.js" id="js"></script>
	</head>
	<body>
	<div class="add">
		<div class="title">添加账单</div>
		...
		<div class="infor">
			<ul>
				...
				<li>
					<div class="name">套现金额：</div>
					<div class="in">
						<input type="text" name="money" id="money" placeholder="套现金额" />	
					</div>
				</li>
				<li>
			...
			<a href="orderRecord.html" class="post">提交审核</a>
			<div class="tip">
				审核通过后，返佣金审核通过后，返佣金审核通过后，返佣金审核通过后，返佣金审核通过后，返佣金审核通过后，返佣金
			</div>
		</div>
