...
<html lang="zh-CN">
	<head>
		...
		<!-- 公告样式 -->
		<link rel="stylesheet" href="/zhongyin/Public/home/css/help.css" id="css">
	  ...
	  <script src="/zhongyin/Public/home/js/common/flexible.js"></script>
		...
		<!-- 公共js -->
		<script src="/zhongyin/Public/home/js/help.js" id="js"></script>
	</head>
	<body>
	<div class="help-box">
		<ul class="help" id="help">
			<li>
				<div class="problem-name">
					...
					<div class="title">我要怎么推广？</div>
					<div class="choose">
						<img src="/zhongyin/Public/home/img/help/1.png" class="down" />
						<img src="/zhongyin/Public/home/img/help/2.png" class="dn up" />
					</div>
				</div>
				<div class="problem-txt dn">
					<h4>问：我们要怎么推广？</h4>
					<p>
						<span>答：</span>您好，首先您需要进入公众平台->点击用户中心->点击专属海报，再点击放大专属二维码海报后，长按保存至手机，您就可以分享倒朋友圈，微信群，或是微信好友完成推广索粉
					</p>
				</div>
			</li>
			<li>
				<div class="problem-name">
					...
					<div class="title">申请信用卡的成功率多大？</div>
					<div class="choose">
						<img src="/zhongyin/Public/home/img/help/1.png" class="down" />
						<img src="/zhongyin/Public/home/img/help/2.png" class="dn up" />
					</div>
