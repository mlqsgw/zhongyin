...
<link href="/caiwu/Public/css/select.css" rel="stylesheet" type="text/css" />
<script type="text/javascript" src="/caiwu/Public/js/jquery.js"></script>
<script type="text/javascript" src="/caiwu/Public/js/jquery.idTabs.min.js"></script>
<script type="text/javascript" src="/caiwu/Public/js/select-ui.min.js"></script>
<script type="text/javascript" src="/caiwu/Public/editor/kindeditor.js"></script>
...
<body>
    ...
    <table class="tablelist">
        ...
        <th>编号<i class="sort"><img src="/caiwu/Public/images/px.gif" /></i></th>
        <th>标题</th>
        <th>用户</th>
        <th>籍贯</th>
        <th>发布时间</th>
