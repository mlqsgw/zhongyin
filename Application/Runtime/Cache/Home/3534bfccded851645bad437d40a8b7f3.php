...
<body>
    ...
    <table class="tablelist">
        ...
        <td><a href="#" class="department_edit" department_edit_id = <?php echo ($vo["id"]); ?>>编辑</a>|<a href="#" class="department_del" department_del_id = <?php echo ($vo["id"]); ?>>删除</a></td>
    ...
    <script type="text/javascript">
       ...
       $(".department_edit").click(function(){
            ...
            var url3 = "<?php echo u('department_edit');?>?id=" + edit_id;
            layer.open({
                type : 2,
                title : "绩绩考核编辑",
                area : ['1210px', '90%'],
                ...
                success : function(data){
                    if(data['status']){
                        layer.open({
                            ...
                            btn : ['确定'],
                            yes : function(){
                                location.href = "<?php echo u('department_list');?>";
                            }
                        });
                    } else {
                        layer.open({
       ...
       $("#add_button").click(function(){
            var url = "<?php echo u('department_add');?>";
            layer.open({
                type : 2,
                title : "部门添加页面",
                area : ['800px', '90%'],
