...
<body>
    ...
    <form id="data_form">
        <div class="formbody">
            <div class="formtitle" id="AddMoreFileBox"><span>问卷调查添加</span></div>
                <ul class="forminfo" >
                    <li><label>标题</label><input type="text" class="dfinput" name="title" value=""/></li>
                    <li id="InputsWrapper"><label>题目1</label><textarea name="question[]" id="field_1" cols="55" rows="10" style="background-color: #ffffff; border: 1px #D7D7D7 solid;font-size: 11px;"></textarea></li><br/>
    ...
    <script type="text/javascript">
        $(".btn").click(function(){
            $.ajax({
                type : "POST",
                url : "<?php echo u('Index/questionnaire_add');?>",
