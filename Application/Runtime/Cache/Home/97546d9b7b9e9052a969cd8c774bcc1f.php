...
<body>
    ...
    <table class="tablelist">
        ...
        <td><?php echo ($vo["title_data"]["title"]); ?></td>
        <td><?php echo ($vo["question"]); ?></td>
        <td><?php echo (date("Y-m-d H:i:s", $vo["create_time"])); ?></td>
        <td><a href="<?php echo u('question_edit');?>?id=<?php echo ($vo["id"]); ?>" class="tablelink">编辑</a>|<a href="<?php echo u('question_del');?>?id=<?php echo ($vo["id"]); ?>" class="tablelink">删除</a></td>
